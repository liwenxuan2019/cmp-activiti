...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (5, 1, 'SQL监控', 'http://localhost:8080/cmp-security/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO schedule_job (job_id, bean_name, params, cron_expression, status, remark, create_time) VALUES (1, 'testTask', 'cmp', '0 0/30 * * * ?', '0', '参数测试', CURRENT_DATE);
